        ...
        <template slot="paneR">
              ...
              <a-row :gutter="48">
                ...
                <a-col :md="8" :sm="24" v-if="advanced">
                  <a-form-item label="手机号">
                    <a-input v-model="queryParam.phonenumber" placeholder="请输入手机号" allow-clear @keyup.enter.native="handleQuery"/>
                  </a-form-item>
                </a-col>
                <a-col :md="8" :sm="24" v-if="advanced">
          ...
          >
            <div class="table-operations" slot="button">
              ...
              <a-button type="" @click="handleExport" v-hasPermi="['system:user:export']">
...
export default {
  ...
  methods: {
    ...
    onSelectChange (selectedRowKeys, selectedRows) {
      ...
      this.userNames = this.selectedRows.map(item => item.name)
