...
import TOfferAddForm from '@/views/shadd/tpurchase/modules/TOfferAddForm'
import TOfferEditForm from '@/views/shadd/tpurchase/modules/TOfferEditForm'
export default {
  name: 'TOffer',
    props: {
        purchaseId: {
  ...
  methods: {
    ...
    getList () {
      this.loading = true
      this.queryParam.purchaseId = this.purchaseId
